...
import 'package:jamrekha/src/elements/AppBarItem.dart';
import 'package:jamrekha/src/elements/SocialItem.dart';
        ...
        children: <Widget>[
          ...
          */
          ...
          Padding(
            ...
            child: _renderSocialList(widget.settings.socials!, context),
          ),
          SizedBox(height: 100),
        ],
      ),
