...
import 'package:jamrekha/src/elements/Loader.dart';
import 'package:jamrekha/src/helpers/HexColor.dart';
import 'package:jamrekha/src/helpers/SharedPref.dart';
import 'package:jamrekha/src/models/setting.dart';
import 'package:jamrekha/src/models/settings.dart';
import 'package:jamrekha/src/pages/SplashScreen.dart';
import 'package:jamrekha/src/repository/settings_service.dart';
import 'package:jamrekha/src/services/theme_manager.dart';
import 'package:jamrekha/src/themes/UIImages.dart';
...
class _InitialScreen extends State<InitialScreen> {
  ...
  Future<void> getSetting() async {
    ...
    try {
      ...
      appLanguage.changeLanguageCode(Setting.getValue(_settings.setting!, "default_language_code"));
